      ...
      <div className="px-4 py-5 space-y-5 max-w-4xl mx-auto">
        ...
        <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
            <Skeleton className="h-20 w-20 rounded-lg border border-border flex-shrink-0" />
        ...
        <div className="rounded-lg border border-border bg-card p-5 shadow-sm mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[1, 2].map((i) => (
              <div key={i} className="flex p-3 rounded-lg border border-border bg-background min-h-[56px]">
