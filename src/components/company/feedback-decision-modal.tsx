...
export function FeedbackDecisionModal({
  ...
  const templates = [
    ...
    },
    {
      ...
      text: `عزيزي ${candidate.name}،\n\nشكراً لتقديمك لفرصة التدريب. لاحظنا شغفك واهتمامك التقني الواعد. نوصيك ببناء مشروع متكامل من الصفر يربط قواعد البيانات السحابية بإدارة الحالة المتقدمة ونظام مصادقة موثوق لرفع جاهزيتك لسوق العمل. نتمنى لك دوام التوفيق والنجاح.`,
